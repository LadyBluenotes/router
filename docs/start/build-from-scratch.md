...
To install them, as well as other dependencies, run:

<!-- ::start:tabs variant="package-manager" -->

react: @tanstack/react-start @tanstack/react-router react react-dom
solid: @tanstack/solid-start @tanstack/solid-router solid-js vite-plugin-solid

<!-- ::end:tabs -->

We also need vite, typescript, and some type definitions:

<!-- ::start:tabs variant="package-manager" mode="dev-install" -->

react: vite vite-tsconfig-paths typescript @vitejs/plugin-react @types/react @types/react-dom @types/node
solid: vite vite-tsconfig-paths typescript @types/node 
